...
class TingkatkesadaranController extends Controller
{
    ...
    {
        return $this->responseFormatter($this->httpCode['StatusOK'], $this->httpMessage['StatusOK'], Vtalsign::all());
    }
    ...
    protected function getData($request)
    {
        ...
        $vitalsign = VtalSign::find($request->id);
